...
class Model(cs.SlikPlugin):
    ...
    def __init__(self,
        ...
        self.planck_constraint = planck_constraint
        ...
        for field in self.fields.groups.keys():
            if field == 'galaxy':
                ...
                if not self.planck_constraint:
                    self['mu_'+field] = param(starts[field],0.04)
    ...
    def __call__(self):
        ...
        if self.planck_constraint:
          return self.__cost__() + 0.5 * (self.H0 -  66.93)**2/0.7**2
        else:
    ...
    def __cost__(self):
        ...
        for cepheid_class in arange(class_num):
            ...
            if self.planck_constraint:
              prob.loc[cepheids.Field == 'galaxy'] = 0
